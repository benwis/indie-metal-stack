...
```
npx create-remix --template benwis/indie-metal-stack
```

## What's in the stack

- Native Rust and WASM Package Support
...
Not a fan of bits of the stack? Fork it, change it, and use `npx create-remix --template benwis/indie-metal-stack`! Make it your own.
